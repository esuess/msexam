...
# files [[year j]] [[fall or spring i]] [[url 1]] [[stat 2]] [[biostat 3]] 
    ...
    d2020 = list( 
      df = list(url = "https://raw.githubusercontent.com/esuess/msexam/master/pastmsexam/2018/Fall2018/",
        fs = list(""),
        fb = list("") ),
      ds = list(url = "https://raw.githubusercontent.com/esuess/msexam/master/pastmsexam/2018/Spring2018/",
        ss = list("battery.csv","homes.csv","covid19.csv"),
        sb = list("battery.csv","homes.csv","burn.csv") ) ),
  
    d2019 = list( 
      df = list(url = "https://raw.githubusercontent.com/esuess/msexam/master/pastmsexam/2019/Fall2019/",
        fs = list("flightdata.csv","gssdata","quakes.csv","loan.txt"),
        fb = list("flightdata.csv","loan.txt","kidrecurr.xlsx") ),
      ds = list(url = "https://raw.githubusercontent.com/esuess/msexam/master/pastmsexam/2019/Spring2019/",
        ss = list("gasoline_addatives.csv","mort.txt","resist.csv","NHANES.txt"),
        sb = list("gasoline_addatives.csv","mort.txt","resist.csv","brain.txt") ) ),
  
    d2018 = list( 
      df = list(url = "https://raw.githubusercontent.com/esuess/msexam/master/pastmsexam/2018/Fall2018/",
        fs = list("SATIS9.csv","SexDisc.txt","heart.csv","DES.txt"),
        fb = list("SATIS9.csv","SexDisc.txt","heart.csv","myeloma.csv") ),
      ds = list(url = "https://raw.githubusercontent.com/esuess/msexam/master/pastmsexam/2018/Spring2018/",
    ...
    d2017 = list( 
      df = list(url = "https://raw.githubusercontent.com/esuess/msexam/master/pastmsexam/2017/Fall2017/",
      ...
      ds = list(url = "https://raw.githubusercontent.com/esuess/msexam/master/pastmsexam/2017/Spring2017/",
    ...
    d2016 = list(
      df = list(url = "https://raw.githubusercontent.com/esuess/msexam/master/pastmsexam/2016/Fall2016/",
      ...
      ds = list(url = "https://raw.githubusercontent.com/esuess/msexam/master/pastmsexam/2016/Spring2016/",
        ss = list("cakemix.txt","problem2.csv","health.txt","DES_all.txt"),
        sb = list("cakemix.txt","problem2.csv","health.txt","selenium.csv") ) ),
    
    d2015 = list(
      df = list(url = "https://raw.githubusercontent.com/esuess/msexam/master/pastmsexam/2015/Fall2015/",
      ...
      ds = list(url = "https://raw.githubusercontent.com/esuess/msexam/master/pastmsexam/2015/Spring2015/",
    ...
    d2014 = list(
      df = list(url = "https://raw.githubusercontent.com/esuess/msexam/master/pastmsexam/2014/Fall2014/",
        fs = list("music.txt","sales.txt","Scout.txt","problem5.txt"),
        fb = list("music.txt","sales.txt","Scout.txt","SevAn.txt") ),
      ds = list(url = "https://raw.githubusercontent.com/esuess/msexam/master/pastmsexam/2014/Spring2014/",
    ...
    d2013 = list(
      df = list(url = "https://raw.githubusercontent.com/esuess/msexam/master/pastmsexam/2013/Fall2013/",
      ...
      ds = list(url = "https://raw.githubusercontent.com/esuess/msexam/master/pastmsexam/2013/Spring2013/",
    ...
    d2012 = list(
      df = list(url = "https://raw.githubusercontent.com/esuess/msexam/master/pastmsexam/2012/Fall2012/",
      ...
      ds = list(url = "https://raw.githubusercontent.com/esuess/msexam/master/pastmsexam/2012/Spring2012/",
    ...
    d2011 = list(
      df = list(url = "https://raw.githubusercontent.com/esuess/msexam/master/pastmsexam/2011/Fall2011/",
        fs = list("release.txt","health.txt","Hodgkin.txt","cans.R"),
        fb = list("release.txt","health.txt","Hodgkin.txt","cans.R","breast.csv") ),
      ds = list(url = "https://raw.githubusercontent.com/esuess/msexam/master/pastmsexam/2011/Spring2011/",
    ...
    d2010 = list(
      df = list(url = "https://raw.githubusercontent.com/esuess/msexam/master/pastmsexam/2010/Fall2010/",
      ...
      ds = list(url = "https://raw.githubusercontent.com/esuess/msexam/master/pastmsexam/2010/Spring2010/",
...
```{r}
download_dir <- "E:/Past_MS_Exams-CSUEB_Statistics_and_Biostatistics"
...
```{r}
download.file("https://raw.githubusercontent.com/esuess/msexam/master/pastmsexam/2009/Fall2009/CONTAM.TXT", file.path(stat_Fall_2009_dir, "CONTAM.TXT"))

download.file("https://raw.githubusercontent.com/esuess/msexam/master/pastmsexam/2009/Fall2009/Reading%20Data.csv", file.path(stat_Fall_2009_dir, "Reading%20Data.csv"))

download.file("https://raw.githubusercontent.com/esuess/msexam/master/pastmsexam/2009/Fall2009/Reading%20Data.txt", file.path(stat_Fall_2009_dir, "Reading Data.txt"))

download.file("https://raw.githubusercontent.com/esuess/msexam/master/pastmsexam/2009/Fall2009/pollination.txt", file.path(stat_Fall_2009_dir, "pollination.txt"))

download.file("https://raw.githubusercontent.com/esuess/msexam/master/pastmsexam/2009/Fall2009/program4.R", file.path(stat_Fall_2009_dir, "program4.R"))

download.file("https://raw.githubusercontent.com/esuess/msexam/master/pastmsexam/2009/Fall2009/Health.txt", file.path(stat_Fall_2009_dir, "Health.txt"))


download.file("https://raw.githubusercontent.com/esuess/msexam/master/pastmsexam/2009/Spring2009/BATTERY.txt", file.path(stat_Spring_2009_dir, "BATTERY.txt"))

download.file("https://raw.githubusercontent.com/esuess/msexam/master/pastmsexam/2009/Spring2009/DataSet.csv", file.path(stat_Spring_2009_dir, "DataSet.csv"))

download.file("https://raw.githubusercontent.com/esuess/msexam/master/pastmsexam/2009/Spring2009/DataSet.txt", file.path(stat_Spring_2009_dir, "DataSet.txt"))

download.file("https://raw.githubusercontent.com/esuess/msexam/master/pastmsexam/2009/Spring2009/compareMSE.R", file.path(stat_Spring_2009_dir, "compareMSE.R"))

download.file("https://raw.githubusercontent.com/esuess/msexam/master/pastmsexam/2009/Spring2009/MMA.txt", file.path(stat_Spring_2009_dir, "MMA.txt"))
